...
public abstract class PostListFragment extends Fragment {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(Post.class, R.layout.item_post,
            ...
            protected void populateViewHolder(final PostViewHolder viewHolder, final Post model, final int position) {
                ...
                if ((model.uid).equals(mAuth.getCurrentUser().getUid())) {
                    deleteMyPost(viewHolder,globalPostRef, userPostRef, model.imageRef);
                }
    ...
    public abstract View.OnClickListener postClick(String uid);
    public abstract void deleteMyPost(PostViewHolder viewHolder, DatabaseReference globalPostRef, DatabaseReference userPostRef, String imageRef);
